...
ActiveRecord::Schema[8.0].define(version: 2025_06_05_065424) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "billing_full_name", null: false
    t.string "billing_address_line", null: false
    t.string "billing_city", null: false
    t.string "billing_zip", null: false
    t.string "billing_country", null: false
    t.string "billing_country_code", null: false
